...
from splendor.envs.mechanics.game_settings import USE_TKINTER
...
if USE_TKINTER:
    ...
    from splendor.envs.graphics.graphics_settings import *
    from splendor.envs.mechanics.action import ActionBuyCard, Action, ActionTradeGems, ActionReserveCard
